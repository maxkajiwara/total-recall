...
export default function StatsView() {
  ...
  const performanceData = [
    ...
    { context: 'Physics', percentage: 92, color: 'bg-primary-custom' },
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-secondary">Track your progress and performance</p>
          </div>
          
          <div className="flex items-center gap-2">
            <span className="text-sm text-secondary">Last</span>
            <select
              value={timeRange}
            ...
            {Array.from({ length: 30 }, (_, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-primary-custom/60 w-2 rounded-t"
                  style={{ minHeight: '4px' }}
                />
              );
            })}
          ...
          <div className="card-custom p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-secondary">Best time of day:</span>
                <span className="font-medium">Morning (9-11 AM)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-secondary">Average session:</span>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-secondary">90%+ retention</div>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <span className="text-2xl">📚</span>
                <div>
                  ...
                  <div className="text-xs text-secondary">500+ cards reviewed</div>
                </div>
              </div>
            </div>
          </div>
